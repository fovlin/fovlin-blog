        ...
        sidebar: [
            {text:'Welcome', link:'/welcome'},
            {
                ...
                items: [
                    ...
                    { text: '认识 Linux 系统', link: '/fovlin-notes/linux-guide/os-guide' },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { text: '应用安装', link: '/fovlin-notes/linux-guide/configure-system/application-install-manage' },
                            { text: '双系统引导', link: '/fovlin-notes/linux-guide/configure-system/double-system-grub' },
                            { text: '磁盘管理', link: '/fovlin-notes/linux-guide/configure-system/disk-manage'},
                            { text: '更改提示符样式', link: '/fovlin-notes/linux-guide/configure-system/custom-terminal' },
                            { text: '桌面环境', link: '/fovlin-notes/linux-guide/configure-system/desktop-env-choose' },
                            { text: 'Nvidia 驱动', link: '/fovlin-notes/linux-guide/configure-system/nvidia-driver' },
